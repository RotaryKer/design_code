...
HD_PWD='/home/users/kakizaki/graduate_report/design_code/vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kc705sitcp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kc705sitcp.tcl -notrace
